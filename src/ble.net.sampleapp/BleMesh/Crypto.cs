...
namespace ble.net.sampleapp.BleMesh
{
   public static class Crypto
   {
      ...
      //initialize a set of salt value which can be used later.
      static Crypto()
      {
      ...
      public static K2KeyMaterial K2(byte[] N, byte[] P)
      {
         ...
         BigInteger modval;
         BigInteger val0 = BigInteger.DivRem(T123_BIGINT, TWO_POW_263, out modval);
      ...
      public static byte[] K3(byte[] N)
      {
         ...
         BigInteger k3_modval;
         BigInteger val1 = BigInteger.DivRem(k3_cmac_bigint, TWO_POW_64, out k3_modval);
         return Utility.HexToBytes(k3_modval.ToString("X"));
      }
